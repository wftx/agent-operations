...
const implementationPackagePattern = /(?:^|\/)(?:agent-operations-rehearsal|cortextos-adapter|cortextos-execution-adapter|cortextos-execution-observer|git-adapter|preview-browser-adapter|external-action-adapter|sqlite-state-adapter|telegram-notification-adapter)(?:\/|$)/;
