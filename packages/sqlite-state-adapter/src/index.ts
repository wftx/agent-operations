...
export {
  ...
  DAILY_DRIVER_TRUST_SCHEMA_VERSION,
  AUTHENTICATED_PREVIEW_SCHEMA_VERSION,
  JOB_RETIREMENT_AND_RESTORE_SCHEMA_VERSION,
  RED_ACTION_RECEIPT_AND_DETERMINISTIC_VERIFICATION_SCHEMA_VERSION,
